...
var anzhiyu = {
  ...
  musicToggle: function (changePaly = true) {
    ...
    let msgPlay =
    '<i class="fa-solid fa-play"></i><span>Play</span>'; // 此處可以更改為你想要顯示的文字
    let msgPause =
    '<i class="fa-solid fa-pause"></i><span>Pause</span>'; // 同上，但兩處均不建議更改
    ...
    if (changePaly) document.querySelector("#nav-music meting-js").aplayer
      .toggle();
  },
  // 音乐伸缩
