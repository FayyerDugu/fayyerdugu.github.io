...
!(function () {
  ...
  class EffectScope {
    constructor(t = !1) {
      ...
      (this.cleanups = []),
      (this.parent = Z),
      !t && Z && (this.index = (Z.scopes || (Z.scopes = [])).push(this) -
      1);
    }
    run(t) {
      if (this.active) {
    ...
    stop(t) {
      if (this.active) {
        let e, n;
        for (e = 0, n = this.effects.length; e < n; e++) this.effects[e]
          .stop();
  ...
  function kt(t = !1) {
    return function (e, n, i, o) {
      ...
      if (
        !t &&
        (oe(i) || ie(i) || ((r = ae(r)), (i = ae(i))), !k(e) && pe(r) && !
          pe(i))
      )
        return (r.value = i), !0;
      ...
      return (
        e === ae(o) && (a ? H(i, r) && pt(e, "set", n, i) : pt(e, "add",
          n, i)),
        c
      );
    };
  ...
  function Ft(t, e) {
    ...
    const a = o.call(n, t);
    return (
      n.set(t, e), r ? H(e, a) && pt(n, "set", t, e) : pt(n, "add", t, e),
      this
    );
  }
  ...
  function $t(t, e) {
    return function (n, i) {
      const o = this,
        ...
        a = ae(r),
        c = e ? St : t ? le : se;
      return !t && ut(a, 0, it), r.forEach((t, e) => n.call(i, c(t), c(e),
        o));
    };
  }
  ...
  const me = {
    ...
    set: (t, e, n, i) => {
      const o = t[e];
      return pe(o) && !pe(n) ? ((o.value = n), !0) : Reflect.set(t, e, n,
        i);
    },
  };
  ...
  function Ie(t) {
    if (je.length) {
      ...
      for (
        Se = t, Se.sort((t, e) => $e(t) - $e(e)), Ee = 0; Ee < Se.length; Ee++
      )
        Se[Ee]();
      (Se = null), (Ee = 0);
    }
    ...
    const g = () => {
      if (y.active)
        if (e) {
          ...
          (l && l(),
            xe(e, c, 3, [t, v === Qe ? void 0 : d && v[0] === Qe ? [] : v,
              m]),
            (v = t));
        } else y.run();
    };
  ...
  function pn(t, e = !1, n) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      a.type === wi ?
        ...
        (e || a.type !== Ci) && i.push(null != c ? Ni(a, {
          key: c
        }) : a);
    }
    if (o > 1)
      ...
      if (o) {
        ...
        if (t === Fn) {
          const t = (function (t, e = !0) {
            return j(t) ? t.displayName || t.name : t.name || (e && t
              .__name);
          })(n, !1);
  ...
  function Ln(t) {
    return t.some(
        (t) => !Mi(t) || (t.type !== Ci && !(t.type === wi && !Ln(t
          .children)))
      ) ?
      t :
      null;
  ...
  function Zn(t) {
    ...
    return (
      ...
      (s = c) :
      o.length || n || i ?
      ((s = {}), o.length && o.forEach((t) => Gn(s, t, a, !0)), Gn(s, e,
      a)) :
      (s = e),
      O(e) && r.set(e, s),
      s
  ...
  function vi(t, e) {
    return function (n, i = null) {
      ...
      const c = (o.app = {
        ...
        component: (t, e) => (e ? ((o.components[t] = e), c) : o
          .components[t]),
        directive: (t, e) => (e ? ((o.directives[t] = e), c) : o
          .directives[t]),
        mount(r, s, l) {
          if (!a) {
            const u = Vi(n, i);
  ...
  function yi(t) {
    return (function (t, e) {
      ...
      g = (
        ...
        x = (t, e, i, o) => {
          null == t ? n((e.el = c(e.children || "")), i, o) : (e.el = t
            .el);
        },
        _ = (t, e, n, i) => {
        ...
        j = (t, e, i, a, c, s, u, d) => {
          ...
          if (
            ((p = t.el = r(t.type, s, m && m.is, m)),
              ...
              l(p, t.children) :
              16 & v &&
              E(t.children, p, null, a, c, s && "foreignObject" !== h, u,
                d),
        ...
        R = (t, e, n, i, r, a, c) => {
          if (n !== i) {
            if (n !== p)
              for (const s in n)
                I(s) || s in i || o(t, s, n[s], null, c, e.children, r, a,
                  Q);
            for (const s in i) {
              if (I(s)) continue;
              const l = i[s],
                u = n[s];
              l !== u && "value" !== s && o(t, s, u, l, c, e.children, r,
                a, Q);
            }
          ...
          const c = (t.component = (function (t, e, n) {
            const i = t.type,
              ...
              r = {
                ...
                exposeProxy: null,
                withProxy: null,
                provides: e ? e.provides : Object.create(o
                  .provides),
                accessCache: null,
                renderCache: [],
                components: null,
          ...
          const c = () => {
              if (t.isMounted) {
                ...
                if (
                  ...
                  p
                    ?
                    e.type.__asyncLoader().then(() => !t.isUnmounted &&
                    n()) :
                    n();
                } else {
            ...
            if (!(i || a > 0) || 16 & a) {
              ...
              for (const r in c)
                ...
                (s ?
                  ...
                  delete o[r]);
              if (r !== c)
                for (const t in r)(e && w(e, t)) || (delete r[t], (l = !
                  0));
            } else if (8 & a) {
          ...
          if (l > d) {
            if (l <= p) {
              const t = p + 1,
                d = t < u ? e[t].el : i;
              for (; l <= p;)
                g(null, (e[l] = s ? qi(e[l]) : Wi(e[l])), n, d, o, r, a,
                  c, s),
                l++;
            }
          } else if (l > p)
                ...
                for (i = 0; i < s; i++) {
                  ...
                  if (0 !== s) {
                    ...
                    for (r = 0, a = n.length - 1; r < a;)
                      (c = (r + a) >> 1), t[n[c]] < s ? (r = c + 1) : (
                        a = c);
                    s < t[n[r]] && (r > 0 && (e[i] = n[r - 1]), (n[r] =
                      i));
                  }
                }
                (r = n.length), (a = n[r - 1]);
        ...
        Z = (t, e, i, o, r = null) => {
          ...
          if (2 !== o && 1 & u && s)
            if (0 === o) s.beforeEnter(a), n(a, e, i), bi(() => s.enter(
              a), r);
            else {
              const {
                leave: t,
        ...
        G = (t, e, n, i = !1, o = !1) => {
          ...
          const f = 1 & u && p,
            h = !hn(t);
          let m;
          if ((h && (m = a && a.onVnodeBeforeUnmount) && Zi(m, e, t), 6 &
              u))
            X(t.component, n, i);
          else {
    ...
    if (null == e) e = null;
      ...
      if (65 & i) {
        ...
        i || $i in e ?
          3 === i &&
          Ue &&
          (1 === Ue.slots._ ? (e._ = 1) : ((e._ = 2), (t.patchFlag |=
          1024))) :
          (e._ctx = Ue);
      }
    } else
    ...
    fo = {
      ...
      insertStaticContent(t, e, n, i, o, r) {
        ...
        if (o && (o === r || o.nextSibling))
          for (; e.insertBefore(o.cloneNode(!0), n), o !== r && (o = o
              .nextSibling););
        else {
    ...
    function b(e, n) {
      return function () {
        ...
        return l instanceof Promise ?
          l
          .then((t) => (Mo(r, t), t))["catch"]((t) => (Mo(a, t), Promise
            .reject(t))) :
          (Mo(r, l), l);
      };
    }
  ...
  (hr = function () {
    ...
    var n = function () {
      var t = {},
        ...
        i = 0,
        o = arguments.length;
      "[object Boolean]" === Object.prototype.toString.call(arguments[
        0]) &&
        ((e = arguments[0]), i++);
      for (
        var r = function (i) {
          for (var o in i)
            ...
            (e && "[object Object]" === Object.prototype.toString.call(
                i[o]) ?
              (t[o] = n(!0, t[o], i[o])) :
              (t[o] = i[o]));
        }; i < o; i++
  ...
  const gr = vr.exports,
    ...
    wr = (t) => (We("data-v-a4f9515c"), (t = t()), qe(), t),
    kr = {
    ...
    Br = (t) => (We("data-v-d2dcb93f"), (t = t()), qe(), t),
    Lr = {
          ...
          return (t, s) => (
            ...
            Ri("div", Lr, [
              Li("audio", {
                ...
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/di.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/di.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
              ...
              Li("audio", {
                ...
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/ac-work.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/ac-work.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
                Ui(" 您的浏览器不支持audio标记（元素） "),
              ...
              Li("audio", {
                ...
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/air-extractor-fan.m4a",
                  preload: "auto",
                }),
                Li("source", {
                  src: "https://alist.anzhiy.cn/d/anzhiyu/air-conditioner-dev/public/assets/audio/air-extractor-fan.mp3",
                  type: "audio/mpeg",
                  preload: "auto",
                }),
                Ui(" 您的浏览器不支持audio标记（元素） "),
                  ...
                  Pr, {
                    ...
                    onClick: s[1] ||
                      (s[1] = (t) =>
                        (function (t) {
                          if ((a(), t)) {
                            document.getElementById("ac-work")
                            .load();
                            const t =
      ...
      return (
        (e.mount = (t) => {
          ...
          return (
            ...
            (i.removeAttribute("v-cloak"), i.setAttribute(
              "data-v-app", "")),
            r
          );
        }),
