...
class MetingJSElement extends HTMLElement {
  ...
  _parse_link() {
    ...
    for (var b = 0; b < a.length; b++) {
      ...
      if (null !== e) return (this.meta.server = c[1]), (this.meta.type = c[
        2]), void(this.meta.id = e[1]);
    }
  }
  _parse() {
    if (this.meta.url) {
      ...
      return (
        ...
        this.innerText && ((a.lrc = this.innerText), (this.meta.lrcType =
          2)),
...
console.log(
  ...
  ((window.MetingJSElement = MetingJSElement), window.customElements.define(
