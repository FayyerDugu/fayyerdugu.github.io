var anzhiyu = {
  ...
  changeMusicBg: function (isChangeBg = true) {
    ...
    if (isChangeBg) {
      ...
      let timer = setInterval(() => {
        ...
        if (musiccover) {
          clearInterval(timer)
          anMusicBg.style.backgroundImage = musiccover.style
            .backgroundImage;
          // 绑定事件
          anzhiyu.addEventListenerChangeMusicBg();
          // 暂停nav的音乐
          if (document.querySelector("#nav-music meting-js").aplayer &&
  ...
  addEventListenerChangeMusicBg: function () {
    ...
    anMusicPage.querySelector("meting-js").aplayer.on('loadeddata',
      function () {
    ...
    document.getElementById('menu-mask').addEventListener("click",
      function () {
        ...
        anMusicPage.querySelector('.aplayer-list').classList.remove(
          "aplayer-list-hide");
      })
  },
}
